...
cookbook 'hops', github: "berthoug/hops-hadoop-chef", branch: "docker"
cookbook 'ndb', github: "logicalclocks/ndb-chef", branch: "master"
cookbook 'hadoop_spark', github: "berthoug/spark-chef", branch: "docker"
cookbook 'flink', github: "berthoug/flink-chef", branch: "docker"
cookbook 'livy', github: "berthoug/livy-chef", branch: "docker"
cookbook 'drelephant', github: "logicalclocks/dr-elephant-chef", branch: "master"
cookbook 'epipe', github: "berthoug/epipe-chef", branch: "docker"
cookbook 'tensorflow', github: "berthoug/tensorflow-chef", branch: "docker"
...
cookbook 'hopslog', github: "berthoug/hopslog-chef", branch: "docker"
cookbook 'hopsmonitor', github: "logicalclocks/hopsmonitor-chef", branch: "master"
cookbook 'hops_airflow', github: "berthoug/airflow-chef", branch: "docker"
cookbook 'hive2', github: "berthoug/hive-chef", branch: "docker"
cookbook 'consul', github: "logicalclocks/consul-chef", branch: "master"
cookbook 'kube-hops', github: "berthoug/kube-hops-chef", branch: "docker"
